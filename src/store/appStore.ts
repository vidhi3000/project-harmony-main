...
export const dummyTasks: Task[] = [
  { id: 't1', title: 'Design new homepage layout', description: 'Create wireframes and mockups for the new homepage', status: 'done', priority: 'high', projectId: 'p1', assignee: dummyUsers[1], dueDate: '2024-02-15', tags: ['design', 'ui'], createdAt: '2024-01-16', updatedAt: '2024-02-10' },
  { id: 't2', title: 'Implement responsive navigation', description: 'Build mobile-first responsive navigation component', status: 'in_progress', priority: 'high', projectId: 'p1', assignee: dummyUsers[2], dueDate: '2024-02-20', tags: ['frontend', 'mobile'], createdAt: '2024-01-18', updatedAt: '2024-02-12' },
  { id: 't3', title: 'Setup CI/CD pipeline', description: 'Configure automated testing and deployment', status: 'review', priority: 'medium', projectId: 'p1', assignee: dummyUsers[0], dueDate: '2024-02-18', tags: ['devops'], createdAt: '2024-01-20', updatedAt: '2024-02-14' },
  { id: 't4', title: 'User authentication flow', description: 'Implement login, signup, and password reset', status: 'todo', priority: 'urgent', projectId: 'p2', assignee: dummyUsers[4], dueDate: '2024-02-25', tags: ['backend', 'security'], createdAt: '2024-01-22', updatedAt: '2024-02-01' },
  ...
  { id: 't6', title: 'Payment gateway integration', description: 'Integrate Stripe for payment processing', status: 'in_progress', priority: 'urgent', projectId: 'p3', assignee: dummyUsers[0], dueDate: '2024-02-22', tags: ['backend', 'payments'], createdAt: '2024-02-02', updatedAt: '2024-02-15' },
  { id: 't7', title: 'Analytics dashboard', description: 'Build analytics overview with charts', status: 'todo', priority: 'high', projectId: 'p3', assignee: dummyUsers[4], dueDate: '2024-02-26', tags: ['frontend', 'data'], createdAt: '2024-02-05', updatedAt: '2024-02-10' },
  { id: 't8', title: 'Create social media assets', description: 'Design graphics for social media campaigns', status: 'in_progress', priority: 'medium', projectId: 'p4', assignee: dummyUsers[2], dueDate: '2024-02-28', tags: ['design', 'marketing'], createdAt: '2024-02-11', updatedAt: '2024-02-16' },
  ...
  { id: 't10', title: 'Performance optimization', description: 'Optimize bundle size and loading speed', status: 'review', priority: 'high', projectId: 'p1', assignee: dummyUsers[2], dueDate: '2024-02-19', tags: ['frontend', 'performance'], createdAt: '2024-01-28', updatedAt: '2024-02-16' },
];
